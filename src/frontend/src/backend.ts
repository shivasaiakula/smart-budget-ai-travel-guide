...
export class Backend implements backendInterface {
    ...
    async addExpense(arg0: string, arg1: string, arg2: string, arg3: number, arg4: string): Promise<Expense> {
        if (this.processError) {
            try {
    ...
    async createTripPlan(arg0: string, arg1: bigint, arg2: bigint, arg3: number, arg4: Array<string>): Promise<TripPlan> {
        if (this.processError) {
            try {
                const result = await this.actor.createTripPlan(arg0, arg1, arg2, arg3, arg4);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async deleteTripPlan(arg0: string): Promise<boolean> {
        if (this.processError) {
            try {
    ...
    async getTripPlan(arg0: string): Promise<TripPlan> {
        if (this.processError) {
            try {
    ...
    async getTripPlans(): Promise<Array<TripPlan>> {
        if (this.processError) {
            try {
                const result = await this.actor.getTripPlans();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
